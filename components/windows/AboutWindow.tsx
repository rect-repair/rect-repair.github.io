  ...
  return (
    <div className='h-full bg-white text-black p-6'>
      <div className='space-y-4 text-sm leading-relaxed'>
        <p>
                  [[rect*]]repair（中文：修四边形） is an art-game collective focusing on making and facilitating experimental games, alternative game jams, community events and public interventions through self-organized events and collaborations with friends and sometimes institutions (ദ്ദി˙ ᴗ ˙ ). Usually happening in Shanghai/Asia.
        </p>
        <p>
